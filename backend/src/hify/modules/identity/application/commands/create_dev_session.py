...
class CreateDevSessionHandler:
    ...
    async def handle(self, command: CreateDevSessionCommand) -> AuthSessionResult:
        ...
        async with self._unit_of_work_factory() as unit_of_work:
            ...
            if user is None:
                ...
                raise IdentityAuthenticationError("user is not active")
            ...
            if team is None:
                ...
                raise IdentityAuthenticationError("team is not active")
            ...
            if membership is None:
                ...
                raise IdentityAuthenticationError("membership is not active")
