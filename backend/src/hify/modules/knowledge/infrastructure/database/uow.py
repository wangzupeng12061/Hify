...
from hify.modules.knowledge.application.ports import KnowledgeUnitOfWork
...
class SqlAlchemyKnowledgeUnitOfWork(KnowledgeUnitOfWork):
    knowledge_bases: SqlAlchemyKnowledgeBaseRepository
    documents: SqlAlchemyKnowledgeDocumentRepository
    chunks: SqlAlchemyKnowledgeChunkRepository
    ...
    async def __aenter__(self) -> Self:
        ...
        self.documents = SqlAlchemyKnowledgeDocumentRepository(self._session)
