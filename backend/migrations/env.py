...
import hify.modules.usage.infrastructure.database.models  # noqa: F401
...
def _database_url() -> str:
    url = os.environ.get("HIFY_DATABASE_URL") or config.get_main_option("sqlalchemy.url")
    if not url:
        raise RuntimeError("Set HIFY_DATABASE_URL or sqlalchemy.url before running Alembic.")
    return url
